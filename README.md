...
This xPack installs the platform specific binaries for the **GNU MCU 
Eclipse ARM Embedded GCC** toolchain.

This xPack project is open source and it is publicly available from 
...
corresponding licenses are available in `the gnu-mcu-eclipse/licenses` folder.